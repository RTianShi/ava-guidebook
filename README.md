...
1.  **左侧导航栏**：包含对话、智能体广场、智能体团队、智能体编排、创作画布、同事、自动化、插件中心、设置、新建会话及工作空间。
2.  **中间对话区**：用于输入指令、查看 Agent 的思考与执行过程。
3.  **右侧工作区 (Workspace)**：提供文件预览、编辑及任务计划展示。
<img width="1680" height="969" alt="图片" src="https://github.com/user-attachments/assets/d33cf06f-74d1-4ae9-ada5-55009f7e72a6" />
